...
void nmod_integer_fft_init_set1(nmod_integer_fft_t F, mp_limb_t w, ulong order, nmod_t mod);
...
// - radix 4
// - inverse fft
// - how to handle "not in place"? (e.g. if evaluating polynomial for fft mul, but polynomial needs to be kept)
