...
/* for xgcd for lengths len1 and len2 */
typedef struct {
    slong len1;
    slong len2;
    slong modn;
...
{ \
    ...
    nmod_poly_t v; \
    nmod_poly_t g; \
    nmod_poly_init(u, modn); \
    nmod_poly_init(v, modn); \
    nmod_poly_init(g, modn); \
    \
...
TIME_XGCD(nmod_poly_xgcd)
TIME_XGCD(nmod_poly_xgcd_hgcd)
TIME_XGCD(nmod_poly_xgcd_euclidean)

SAMPLE_XGCD(nmod_poly_xgcd)
SAMPLE_XGCD(nmod_poly_xgcd_hgcd)
SAMPLE_XGCD(nmod_poly_xgcd_euclidean)
...
int main(int argc, char ** argv)
{
    ...
    const timefun funs[] = {
        time_nmod_poly_xgcd,               // 0
        time_nmod_poly_xgcd_hgcd,          // 1
        time_nmod_poly_xgcd_euclidean,     // 2
    };

    typedef void (*samplefun) (void*, ulong);
    const samplefun sfuns[] = {
        sample_nmod_poly_xgcd,               // 0
        sample_nmod_poly_xgcd_hgcd,          // 1
        sample_nmod_poly_xgcd_euclidean,     // 2
    };

    const char * description[] = {
        "#0  --> nmod_poly_xgcd           ", 
        "#1  --> nmod_poly_xgcd_hgcd      ", 
        "#2  --> nmod_poly_xgcd_euclidean ", 
    };
