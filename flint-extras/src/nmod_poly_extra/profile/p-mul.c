...
/* for multiplication in length len1 x len2 */
typedef struct {
    slong len1;
    slong len2;
    slong modn;
...
TIME_MUL(nmod_poly_mul)
TIME_MUL(nmod_poly_mul_classical)
TIME_MUL(nmod_poly_mul_KS)
TIME_MUL(nmod_poly_mul_KS2)
TIME_MUL(nmod_poly_mul_KS4)
