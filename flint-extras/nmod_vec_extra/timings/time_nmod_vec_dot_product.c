...
void time_nmod_vec_dot_product(ulong len, ulong maxbits1, ulong maxbits2, ulong n, flint_rand_t state)
{
    ...
    //    _nmod_vec_rand(v2, state, len, mod2);
    //    tt = clock();
    //    _nmod_vec_dot_product_2_v16_int128(v1, v2, len, mod);
    //    _nmod_vec_dot_product_2_v16_int128(v1, v2, len, mod);
    //    _nmod_vec_dot_product_2_v16_int128(v1, v2, len, mod);
    //    _nmod_vec_dot_product_2_v16_int128(v1, v2, len, mod);
    //    _nmod_vec_dot_product_2_v16_int128(v1, v2, len, mod);
    ...
    while (t2 < 0.2)
    {
        ...
        _nmod_vec_rand(v2, state, len, mod2);
        tt = clock();
        _nmod_vec_dot_product_2_vec16_int128(v1, v2, len, mod);
        _nmod_vec_dot_product_2_vec16_int128(v1, v2, len, mod);
        _nmod_vec_dot_product_2_vec16_int128(v1, v2, len, mod);
        _nmod_vec_dot_product_2_vec16_int128(v1, v2, len, mod);
        _nmod_vec_dot_product_2_vec16_int128(v1, v2, len, mod);
    ...
    if (val1 != val2)
        printf("\nERROR!!!!!\n");
    val2 = _nmod_vec_dot_product_2_vec16_int128(v1, v2, len, mod);
    if (val1 != val2)
        printf("\nERROR!!!!!\n");
