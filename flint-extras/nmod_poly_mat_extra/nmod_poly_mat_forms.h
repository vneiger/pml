 ...
 * \todo
 */
//int is_row_polmatform( form, pmat );
 ...
 * \todo
 */
//int is_row_polmatform( form, pmat, shift );
 ...
 * \todo
 */
//int is_column_polmatform( form, pmat );
