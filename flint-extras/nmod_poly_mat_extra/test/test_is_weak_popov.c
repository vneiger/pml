...
int main()
{
    ...
    // True
    iswp = nmod_poly_mat_is_weak_popov_rowwise(mat);
    ...
    // True
    iswp = nmod_poly_mat_is_ordered_weak_popov_rowwise(mat);
    ...
    iswp = nmod_poly_mat_is_weak_popov_rowwise(mat2);
    printf("Checking is weak Popov row-wise: %d --> %s\n",
           iswp, (iswp==1) ? "ok" : "not ok");
    iswp = nmod_poly_mat_is_ordered_weak_popov_rowwise(mat2);
    printf("Checking is ordered weak Popov row-wise: %d --> %s\n\n",
    ...
    iswp = nmod_poly_mat_is_weak_popov_shifted_rowwise(mat, shift);
    ...
    iswp = nmod_poly_mat_is_ordered_weak_popov_shifted_columnwise(mat, shift);
    ...
    iswp = nmod_poly_mat_is_weak_popov_shifted_rowwise(mat, shift2);
    printf("Checking is (0,3,2,2)-weak Popov row-wise: %d --> %s\n",
           iswp, (iswp==1) ? "ok" : "not ok");
    // TODO

    iswp = nmod_poly_mat_is_ordered_weak_popov_shifted_rowwise(mat, shift2);
    ...
    iswp = nmod_poly_mat_is_weak_popov_shifted_rowwise(mat, shift3);
    printf("Checking is (0,2,1,3)-weak Popov row-wise: %d --> %s\n",
           iswp, (iswp==1) ? "ok" : "not ok");

    iswp = nmod_poly_mat_is_ordered_weak_popov_shifted_rowwise(mat, shift3);
    ...
    iswp = nmod_poly_mat_is_weak_popov_columnwise(mat);
