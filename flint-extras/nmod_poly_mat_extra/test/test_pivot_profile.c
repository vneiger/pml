...
int main()
{
    ...
    // [0, 0]
    nmod_poly_mat_pivot_profile_rowwise(rpivind, rpivdeg, mat);
    ...
    // ([2, 0], [0, 3])
    nmod_poly_mat_pivot_profile_shifted_rowwise(rpivind, rpivdeg, mat, rshift);
    ...
    // ([1, -1, 0], [3, -1, 0])
    nmod_poly_mat_pivot_profile_columnwise(cpivind, cpivdeg, mat);
    ...
    //                           ....:   return_degree=True)
    // ([1, -1, 0], [3, -1, 0])
    nmod_poly_mat_pivot_profile_shifted_columnwise(cpivind, cpivdeg, mat, cshift);
