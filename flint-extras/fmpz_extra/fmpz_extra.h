...
/* ------------------------------------------------------------ */
void fmpz_CRT_naive_init(fmpz_CRT_naive_t mmod, mp_srcptr primes, ulong num_primes);
...
/* ------------------------------------------------------------ */
void fmpz_CRT_naive_combine(fmpz_t A, mp_srcptr m, const fmpz_CRT_naive_t mCRT);

/* ------------------------------------------------------------ */
/* compute A s.t. A mod primes[j] = m[j] for all j              */
/* ------------------------------------------------------------ */
void fmpz_CRT_naive_CRT(fmpz_t A, mp_srcptr m, const fmpz_CRT_naive_t mCRT);
